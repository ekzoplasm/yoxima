 ...
 */
class Comments extends \yoxima\BlogBundle\Entity\Comments implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::increaseNbComments();
    }

    public function decreaseNbComments()
    {
        $this->__load();
        return parent::decreaseNbComments();
    }


    public function __sleep()
    {
        return array('__isInitialized__', 'id', 'date', 'author', 'content', 'article');
    }
