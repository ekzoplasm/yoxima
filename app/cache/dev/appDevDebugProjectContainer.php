...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'yoxima_blog.antispam' => 'getYoximaBlog_AntispamService',
            'yoxima_blog.percentutil' => 'getYoximaBlog_PercentutilService',
        );
        $this->aliases = array(
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'yoxima', 'user' => 'fabrice', 'password' => 'RVapt3FOA', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $d, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\wamp\\www\\Symfony\\src\\yoxima\\BlogBundle\\Entity')), 'yoxima\\BlogBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('yoximaBlogBundle' => 'yoxima\\BlogBundle\\Entity'));
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $instance->setUsername('fabrice.antinoro@gmail.com');
        $instance->setPassword('RVapt3FOA');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('owner', 'fabrice antinoro © 2014');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp\\www\\Symfony\\src\\yoxima\\BlogBundle/Resources/views', 'yoximaBlog');
    ...
    /**
     * Gets the 'yoxima_blog.antispam' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return yoxima\BlogBundle\Antispam\YoximaAntispam A yoxima\BlogBundle\Antispam\YoximaAntispam instance.
     */
    protected function getYoximaBlog_AntispamService()
    {
        return $this->services['yoxima_blog.antispam'] = new \yoxima\BlogBundle\Antispam\YoximaAntispam($this->get('swiftmailer.mailer.default'), 'fr', 3);
    }

    /**
     * Gets the 'yoxima_blog.percentutil' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return yoxima\BlogBundle\PercentUtil\YoximaPercentUtil A yoxima\BlogBundle\PercentUtil\YoximaPercentUtil instance.
     */
    protected function getYoximaBlog_PercentutilService()
    {
        return $this->services['yoxima_blog.percentutil'] = new \yoxima\BlogBundle\PercentUtil\YoximaPercentUtil();
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'yoximaBlogBundle' => 'yoxima\\BlogBundle\\yoximaBlogBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'yoxima',
            'database_user' => 'fabrice',
            'database_password' => 'RVapt3FOA',
            'mailer_transport' => 'gmail',
            'mailer_host' => NULL,
            'mailer_user' => 'fabrice.antinoro@gmail.com',
            'mailer_password' => 'RVapt3FOA',
            'locale' => 'fr',
            'secret' => 'ThisTokenIsNotSoSecretChangeIt',
            'app_owner' => 'fabrice antinoro © 2014',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'fabrice.antinoro@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'RVapt3FOA',
